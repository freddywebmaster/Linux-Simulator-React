import logo from "assets/apps/linux.png";
import Image from "next/image";

const StartPage = () => {
  return (
    <div className="h-screen bg-[#23104B] flex items-center justify-center">
      <div className="flex flex-col items-center justify-center">
        ...
        />
        <svg
          className="text-2xl text-white text-center animate-spin"
          stroke="currentColor"
          fill="currentColor"
          strokeWidth={0}
          version="1.1"
        ...
        <h2 className="font-bold animate-pulse text-white text-lg text-center">
          Cargando linux...
        </h2>
      </div>
    </div>
